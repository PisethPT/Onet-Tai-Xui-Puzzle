...
public class Level3 : MonoBehaviour
{
    ...
    public GameObject optionOject, congrate;
    ...
    void Start()
    {
        ...
        level1[2].SetActive(true);
        levelScripts[0].SetActive(false);
        levelScripts[1].SetActive(false);
        levelScripts[2].SetActive(true);
      //  GetValueRandom();
    }

    void Update()
    {
        //if(FindObjectOfType<LevelLoading>().gameUpdate)
        //{
        //    GetValueRandom();
        //    FindObjectOfType<LevelLoading>().gameUpdate = false;
        //}
    }
